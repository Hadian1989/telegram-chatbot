...
public interface Assistant {
    @SystemMessage(
            """
                    You are helpful assistant. Try to respond in a fair and warm manner.
    ...
    BookModel extractBookFromText(@V("text") String text, @V("genresList") List<String> genresList);
}